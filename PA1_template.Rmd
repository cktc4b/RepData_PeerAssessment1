...
I also calculated the mean number of steps taken per day, which is `r prettyNum(m1)`, and the median number of steps per day, which is `r m2`.
...
I also found the time with the peak activity, or the greatest average number of steps, which is `r t1`.
